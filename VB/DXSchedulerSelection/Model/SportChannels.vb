...
Namespace DXSchedulerSelection
    ...
    Public Class SportChannelsData
        Public Shared ReadOnly SportGroups() As SportGroup = { _
            New SportGroup() With { _
                .Id = 0, _
                .Caption = "SportNews", _
            ...
            New SportGroup() With { _
                .Id = 1, _
                .Caption = "Basketball", _
                .Color = Color.FromRgb(&HFF, &HC2, &HBE) _
            }, _
            New SportGroup() With { _
                .Id = 2, _
                .Caption = "Boxing", _
                .Color = Color.FromRgb(&HA8, &HD5, &HFF) _
            }, _
            New SportGroup() With { _
                .Id = 3, _
                .Caption = "Tennis", _
                .Color = Color.FromRgb(&HC1, &HF4, &H9C) _
            }, _
            New SportGroup() With { _
                .Id = 4, _
                .Caption = "Soccer", _
                .Color = Color.FromRgb(&HF3, &HE4, &HC7) _
            }, _
            New SportGroup() With { _
                .Id = 5, _
                .Caption = "Artistic Gymnastics", _
                .Color = Color.FromRgb(&HF4, &HCE, &H93) _
            }, _
            New SportGroup() With { _
                .Id = 6, _
                .Caption = "Canoe", _
                .Color = Color.FromRgb(&HC7, &HF4, &HFF) _
            }, _
            New SportGroup() With { _
                .Id = 7, _
                .Caption = "Kayak", _
                .Color = Color.FromRgb(&HCF, &HDB, &H98) _
            }, _
            New SportGroup() With { _
                .Id = 8, _
                .Caption = "Sailing", _
                .Color = Color.FromRgb(&HE0, &HCF, &HE9) _
            }, _
            New SportGroup() With { _
                .Id = 9, _
                .Caption = "Swimming", _
                .Color = Color.FromRgb(&H8D, &HE9, &HDF) _
            }, _
            New SportGroup() With { _
                .Id = 10, _
                .Caption = "Shooting", _
                .Color = Color.FromRgb(&HFF, &HF7, &HA5) _
            } _
        }
        ...
        End Function
        #Region "Sample Data"
        Private Shared ReadOnly sportChannels() As SportChannel = { _
            New SportChannel() With { _
                .Id = 0, _
                .Caption = "SPORT TV 1", _
                .NewsTimeRange = GetRandomNewsTimeRange(TimeSpan.FromHours(11)) _
            }, _
            New SportChannel() With { _
                .Id = 1, _
                .Caption = "SPORT TV 2", _
                .NewsTimeRange = GetRandomNewsTimeRange(TimeSpan.FromHours(19)) _
            }, _
            New SportChannel() With { _
                .Id = 2, _
                .Caption = "SPORT TV 3" _
            }, _
            New SportChannel() With { _
                .Id = 3, _
                .Caption = "SPORT TV 4" _
            }, _
            New SportChannel() With { _
                .Id = 4, _
                .Caption = "TV 5" _
