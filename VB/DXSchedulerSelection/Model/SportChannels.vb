...
Namespace DXSchedulerSelection
    ...
    Public Class SportChannelsData
        ...
        Private _Groups As ObservableCollection(Of DXSchedulerSelection.SportGroup), _Channels As ObservableCollection(Of DXSchedulerSelection.SportChannel), _Events As ObservableCollection(Of DXSchedulerSelection.SportEvent)

        Public Shared ReadOnly SportGroups As SportGroup() = {New SportGroup() With {.Id = 0, .Caption = "SportNews", .Color = Colors.White}, New SportGroup() With {.Id = 1, .Caption = "Basketball", .Color = Color.FromRgb(&HFF, &HC2, &HBE)}, New SportGroup() With {.Id = 2, .Caption = "Boxing", .Color = Color.FromRgb(&HA8, &HD5, &HFF)}, New SportGroup() With {.Id = 3, .Caption = "Tennis", .Color = Color.FromRgb(&HC1, &HF4, &H9C)}, New SportGroup() With {.Id = 4, .Caption = "Soccer", .Color = Color.FromRgb(&HF3, &HE4, &HC7)}, New SportGroup() With {.Id = 5, .Caption = "Artistic Gymnastics", .Color = Color.FromRgb(&HF4, &HCE, &H93)}, New SportGroup() With {.Id = 6, .Caption = "Canoe", .Color = Color.FromRgb(&HC7, &HF4, &HFF)}, New SportGroup() With {.Id = 7, .Caption = "Kayak", .Color = Color.FromRgb(&HCF, &HDB, &H98)}, New SportGroup() With {.Id = 8, .Caption = "Sailing", .Color = Color.FromRgb(&HE0, &HCF, &HE9)}, New SportGroup() With {.Id = 9, .Caption = "Swimming", .Color = Color.FromRgb(&H8D, &HE9, &HDF)}, New SportGroup() With {.Id = 10, .Caption = "Shooting", .Color = Color.FromRgb(&HFF, &HF7, &HA5)}}
